...
export const LoaderOne = () => {
  ...
  return (
    <div className="flex items-center justify-center  gap-2 w-[98vw] my-20">
      <motion.div
        initial={{
          y: 0,
        }}
        ...
        className="h-4 w-4 rounded-full border border-[#81dd1f] bg-gradient-to-b from-[#81dd1f]/90 to-[#81dd1f]"
      />
      <motion.div
        initial={{
          y: 0,
